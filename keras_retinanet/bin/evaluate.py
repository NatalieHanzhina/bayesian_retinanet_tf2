...
def parse_args(args):
    ...
    parser.add_argument('--crop',             help='Crop bboxes from images and save annotations', action='store_true')
    parser.add_argument('--group',            help='Group cropped bboxes from images by class and save annotations in folders', action='store_true')
