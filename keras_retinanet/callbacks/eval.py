 ...
 # ____________________Sigmas block__________________________
            if self.tensorboard:
                ...
                with writer.as_default():
                    ...
                    # tf.summary.scalar("running_mean", self.running_stats[0], step=epoch)
                    # tf.summary.scalar("running_var", self.running_stats[1], step=epoch)
                    # if self.verbose == 14:
                    #     for label, (average_precision, num_annotations) in average_precisions.items():
            ...
            # logs['running_mean'] = self.running_stats[0,:]
            # logs['running_var'] = self.running_stats[1,:]
